	...
	%ruleCataloge = (
		...
		'_flag_dna_bendingstiffness_rule' => {
			...
			'_flag_stacking_energy' => {
							...
							{'max_value'} => '-3.82 kcal',
							{'pmid'}      => 'DOI: 10.1002/bip.1978.360171005',#none does not have pmid
			},
			'_flag_nuc_pos_pref' => {
			...
			'_flag_twist_parmbsc0' => {
							{'simple'}    => 'twist',
							{'ktuple'}    => 2,
							{'details'}   => 'rotation around the rise axis (z axis) of B DNA calculated from the froce field. ( rotational deformability )',
			...
			'_flag_tilt_parmbsc0' => {
							{'simple'}    => 'tilt',
							{'ktuple'}    => 2,
							{'details'}   => 'rotation around the shift axis (x axis) of B DNA calculated from the froce field. ( rotational deformability) ',
			...
			'_flag_roll_parmbsc0' => {
							{'simple'}    => 'roll',
							{'ktuple'}    => 2,
							{'details'}   => 'rotation around the slide axis (y axis) .(rotational deformability )',
			...
			'_flag_shift_parmbsc0' => {
							{'simple'}    => 'shift',
							{'ktuple'}    => 2,
							{'details'}   => 'displacement along an axis (x axis) in the base-pair plane perpendicular to the first, directed from the minor to the major groove. (translational deformability)',
			...
			'_flag_slide_parmbsc0' => {
							{'simple'}    => 'slide',
							{'ktuple'}    => 2,
							{'details'}   => 'displacement along an axis ( y axi) in the plane of the base pair directed from one strand to the other. (translational deformability)',
			...
			'_flag_rise_parmbsc0' => {
							{'simple'}    => 'rise',
							{'ktuple'}    => 2,
							{'details'}   => 'displacement along the helix axis (z axis).(translational deformability)',
